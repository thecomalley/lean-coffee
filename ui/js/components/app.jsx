        ...
        <section className="home-container">
          <div className="upper-box">
            ...
            <div className="description-list">
              <Link
                to="/how"
                className={isActive("how")}
                onClick={this.setActive.bind(this, "how")}
              >
                How
              </Link>
              <Link
                to="/when"
                className={isActive("when")}
                onClick={this.setActive.bind(this, "when")}
              >
                When
              </Link>
              <Link
                to="/safety"
                className={isActive("safety")}
                onClick={this.setActive.bind(this, "safety")}
              >
                Safety
              </Link>
            </div>
          ...
          <div className="lower-box">{this.props.children}</div>
        </section>
      </main>
    );
  }
